...
@Configuration
@EnableMongoRepositories("br.com.ifood.advancedtest.spotify.microservice.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("br.com.ifood.advancedtest.spotify.microservice.config.dbmigrations");
